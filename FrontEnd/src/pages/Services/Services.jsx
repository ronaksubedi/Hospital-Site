...
import heroImg from "../../assets/HeroImage.jpg"; // adjust path/name to match your actual file
      ...
      >
        ...
        <div style={{ flex: "1 1 400px", textAlign: "left" }}>
          ...
          <p style={{ color: "#6B7280", maxWidth: "500px" }}>
            Comprehensive medical services delivered with care and expertise.
          </p>
        </div>
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div style={{ padding: "24px" }}>
                  ...
                  <h3 style={{ fontSize: "18px", fontWeight: "700", color: "#111827", margin: "12px 0 8px" }}>
                    {service.name}
                  </h3>
                  ...
                  <Link to="/appointments" style={{ color: "#3B82F6", fontSize: "14px", fontWeight: "600", textDecoration: "none" }}>
                    Book Appointment →
                  </Link>
                </div>
              </div>
