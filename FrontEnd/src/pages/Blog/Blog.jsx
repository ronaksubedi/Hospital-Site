  ...
  return (
    <div>
      <div style={{ background: "linear-gradient(to right, #EFF6FF, #DBEAFE)", padding: "60px 24px", textAlign: "center" }}>
        <p style={{ color: "#3B82F6", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.1em", fontSize: "13px", marginBottom: "12px" }}>Latest Updates</p>
        <h1 style={{ fontSize: "42px", fontWeight: "800", color: "#111827", marginBottom: "16px" }}>News & Blog</h1>
        <p style={{ color: "#6B7280", maxWidth: "500px", margin: "0 auto" }}>Stay updated with the latest health tips and medical news.</p>
      </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "24px" }}>
            {blogs.map((blog) => (
              <Link to={"/blog/" + blog.slug} key={blog._id} style={{ textDecoration: "none" }}>
                <div style={{ background: "white", borderRadius: "16px", overflow: "hidden", boxShadow: "0 2px 12px rgba(0,0,0,0.06)", transition: "transform 0.2s", height: "100%" }}
                ...
                >
                  ...
                  <div style={{ padding: "24px" }}>
                    ...
                    <h3 style={{ fontSize: "17px", fontWeight: "700", color: "#111827", margin: "12px 0 8px", lineHeight: "1.4" }}>{blog.title}</h3>
                    <p style={{ color: "#6B7280", fontSize: "14px", lineHeight: "1.7", marginBottom: "16px" }}>{blog.excerpt}</p>
