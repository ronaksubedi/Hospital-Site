    ...
    <div>
      <div style={{ background: "linear-gradient(to right, #EFF6FF, #DBEAFE)", padding: "40px 24px" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <h1 style={{ fontSize: "36px", fontWeight: "800", color: "#111827", lineHeight: "1.3", marginBottom: "20px" }}>{blog.title}</h1>
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "40px 24px 80px" }}>
        {blog.coverImage && (
          <img src={blog.coverImage} alt={blog.title} style={{ width: "100%", height: "400px", objectFit: "cover", borderRadius: "16px", marginBottom: "40px" }} />
        )}
        {blog.excerpt && (
        ...
        <div style={{ fontSize: "16px", color: "#374151", lineHeight: "1.9", whiteSpace: "pre-wrap" }}>{blog.content}</div>
        {blog.tags?.length > 0 && (
          <div style={{ marginTop: "40px", display: "flex", gap: "8px", flexWrap: "wrap", alignItems: "center" }}>
            <Tag size={16} color="#9CA3AF" />
            {blog.tags.map((tag, i) => (
              <span key={i} style={{ background: "#F3F4F6", color: "#374151", padding: "4px 12px", borderRadius: "999px", fontSize: "13px" }}>{tag}</span>
            ))}
          </div>
        )}
        <div style={{ marginTop: "48px", paddingTop: "32px", borderTop: "1px solid #E5E7EB" }}>
          <Link to="/blog" style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: "#1B2F6E", color: "white", padding: "12px 24px", borderRadius: "8px", textDecoration: "none", fontWeight: "600", fontSize: "14px" }}>
