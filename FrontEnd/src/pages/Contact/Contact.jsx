  ...
  return (
    <div>
      <div style={{ background: "linear-gradient(to right, #EFF6FF, #DBEAFE)", padding: "60px 24px", textAlign: "center" }}>
        <p style={{ color: "#3B82F6", fontWeight: "600", textTransform: "uppercase", letterSpacing: "0.1em", fontSize: "13px", marginBottom: "12px" }}>Get In Touch</p>
        <h1 style={{ fontSize: "42px", fontWeight: "800", color: "#111827", marginBottom: "16px" }}>Contact Us</h1>
        <p style={{ color: "#6B7280", maxWidth: "500px", margin: "0 auto" }}>Have questions? We're here to help you.</p>
      </div>
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "60px 24px 80px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: "40px" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            {[
              { icon: <Phone size={20} color="#3B82F6" />, title: "Emergency", value: "(237) 681-812-255" },
              ...
              <div key={i} style={{ background: "white", borderRadius: "12px", padding: "20px", boxShadow: "0 2px 12px rgba(0,0,0,0.06)", display: "flex", gap: "16px", alignItems: "flex-start" }}>
                <div style={{ background: "#EFF6FF", padding: "12px", borderRadius: "10px", flexShrink: 0 }}>{item.icon}</div>
                <div>
          ...
          <div style={{ background: "white", borderRadius: "16px", padding: "40px", boxShadow: "0 2px 12px rgba(0,0,0,0.08)" }}>
            ...
            {success && <div style={{ background: "#D1FAE5", color: "#065F46", padding: "12px 16px", borderRadius: "8px", marginBottom: "20px", fontSize: "14px" }}>{success}</div>}
            {error && <div style={{ background: "#FEE2E2", color: "#991B1B", padding: "12px 16px", borderRadius: "8px", marginBottom: "20px", fontSize: "14px" }}>{error}</div>}
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div>
                ...
                <textarea name="message" value={form.message} onChange={handleChange} placeholder="Write your message here..." required rows={5} style={{ ...inputStyle, resize: "vertical" }} />
              </div>
